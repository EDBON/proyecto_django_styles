# Generated by Django 5.1.4 on 2025-06-30 19:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puesto_empresa', models.CharField(choices=[('it', 'IT'), ('usuario', 'Usuario'), ('medico', 'Médico'), ('admin', 'Administrador'), ('persona', 'persona'), ('auxiliar', 'Auxiliar')], default='it', max_length=50)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('empleado', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='clinic_master_app.empleado')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_formacion', models.CharField(choices=[('pregrado', 'Pregrado'), ('posgrado', 'Posgrado'), ('diplomado', 'Diplomado'), ('curso', 'Curso'), ('tecnico', 'Técnico'), ('otro', 'Otro')], max_length=20)),
                ('institucion', models.CharField(max_length=150)),
                ('fecha_inicio', models.DateField()),
                ('fecha_fin', models.DateField(blank=True, null=True)),
                ('titulo_obtenido', models.CharField(max_length=150)),
                ('estado', models.CharField(choices=[('completa', 'Completa'), ('en_curso', 'En curso'), ('incompleta', 'Incompleta')], default='completa', max_length=20)),
                ('certificado', models.FileField(blank=True, null=True, upload_to='formacion/certificados/')),
        ...
        migrations.AddField(
            model_name='usuario',
            name='persona',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='clinic_master_app.persona'),
        ),
        migrations.CreateModel(
